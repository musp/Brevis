    ...
    public class Altera : Dados
    {
        ...
        public T AlteraT<T>(T objeto, int conexao)
        {
            ...
            string comando = acao
                ...
                .Replace("COLUNASDADOS", parametros.Where(s => s.ParameterName == "ColunasValores").FirstOrDefault().Value.ToString()).Replace("CLAUSULAS", parametros.Where(s => s.ParameterName == "Parametros").FirstOrDefault().Value.ToString());
